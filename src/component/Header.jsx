...
import header from "../assets/premium.png"
            ...
            <div className="container mx-auto py-[16vh]">
                <div className="grid grid-cols-1 relative lg:grid-cols-2 gap-8 items-center">
                    <div className="lg:w-[32rem] w-full flex flex-col space-y-6">
                        <div className="text-4xl md:text-5xl font-bold text-[#2e2e2e] lg:text6xl">
                            we are <span className="text-[#f54748]">
                                Serious
                            </span> For <span className="text-[#f54748]">Food</span> &
                            <span className="text-[#Fdc55e]"> Delivary .</span>
                        </div>

                        <div className="lg:text-xl text-[#191919] md:text-lg text-base">
                            An online food ordering system is software that allows restaurants, coffee shops, or bars to accept orders online. Here’s how it typically works:
                        ...
                        <div className="flex rounded-full py-2 px-4 justify-between items-center bg:white shadow-md ">
                            <div className="flex items-center">
                                ...
                                <input type="text" placeholder="Search food here..." className="text-[#191919] w-full border-none outline-none 
                                py-2 px-4" />
                        ...
                        <div className="flex  gap-8  items-center">
                            ...
                            <div className="sm:flex  hidden gap-4 items-center">
                                ...
                                <div className="h-14 w-14 shadow-md cursor-pointer ralative bg-white
                                 rounded-full ">
                                    <FaPlay size={18} className='cursor-pointer text-[#f54748] absolute top-1/2 
                                    left-1/2 -translate-x-1/2 -translate-y-1/2' />
